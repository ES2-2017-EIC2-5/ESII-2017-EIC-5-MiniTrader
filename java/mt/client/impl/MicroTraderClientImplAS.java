...
public class MicroTraderClientImplAS implements MicroTraderClient {
	
	public static void main(String args[]) {
		ClientComm clientComm = new ClientCommImpl();
		MicroTraderClient client = new MicroTraderClientImplAS();
		client.start(clientComm);
		Logger.getLogger(MicroTraderClientImplAS.class.getName()).log(Level.INFO, "This is the end...");
	}
