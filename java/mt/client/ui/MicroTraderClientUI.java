...
public class MicroTraderClientUI extends javax.swing.JFrame {
    ...
    private final String screenTitle = "Mini Trader";//ALTERAÇÃO MICRO-> MINI
    ...
    private void initComponents() {
        ...
        placeOrderBtn.setBackground(Color.BLUE);
        ...
        placeOrderBtn.setBackground(Color.BLUE); //MUDAR COR DO BOTÃO
        ...
        fileMenu.add(myAccount);//ACRESCENTAR AÇÃO AO MENU-FILE
        fileMenu.add(jSeparator);
        
        myAccount.setText("My Account");
        
        exit.setText("Logout");//MUDAR NOME
